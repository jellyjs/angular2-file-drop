...
export class Wrapper_FileDropDirective {
  ...
  handleEvent(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'dragover')) {
      const pd_sub_0:any = ((<any>this.context.onDragOver($event)) !== false);
      result = (pd_sub_0 && result);
    }
    if ((eventName == 'dragleave')) {
      const pd_sub_1:any = ((<any>this.context.onDragLeave($event)) !== false);
      result = (pd_sub_1 && result);
    }
    if ((eventName == 'drop')) {
      const pd_sub_2:any = ((<any>this.context.onDrop($event)) !== false);
